...
namespace Pulse.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventApplications_Users_ApplicantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventApplications_ApplicantId",
                table: "EventApplications",
                column: "ApplicantId");

            migrationBuilder.CreateIndex(
                name: "IX_EventApplications_EventId_ApplicantId",
                table: "EventApplications",
                columns: new[] { "EventId", "ApplicantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventApplications_EventId_Status",
                table: "EventApplications",
                columns: new[] { "EventId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Events_CategoryType",
                table: "Events",
                column: "CategoryType");
